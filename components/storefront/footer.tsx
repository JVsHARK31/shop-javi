      ...
      <div className="container px-3 py-8 sm:px-4 sm:py-10 md:py-12">
        <div className="grid gap-8 sm:gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-3">
            <h3 className="text-sm font-bold sm:text-base md:text-lg">Javier_shark006 Shop</h3>
          ...
          <div className="space-y-3">
            <h3 className="text-sm font-bold sm:text-base md:text-lg">Kategori</h3>
            <ul className="space-y-2.5 text-xs sm:text-sm">
              <li>
                <Link href="/?kategori=Template Design" className="text-muted-foreground transition-colors hover:text-primary active:text-primary">
                  Template Design
                </Link>
              </li>
              <li>
                <Link href="/?kategori=E-book & Panduan" className="text-muted-foreground transition-colors hover:text-primary active:text-primary">
                  E-book & Panduan
                </Link>
              </li>
              <li>
                <Link href="/?kategori=Preset & Assets" className="text-muted-foreground transition-colors hover:text-primary active:text-primary">
                  Preset & Assets
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-3">
            <h3 className="text-sm font-bold sm:text-base md:text-lg">Kontak</h3>
          ...
          <div className="space-y-3">
            <h3 className="text-sm font-bold sm:text-base md:text-lg">Informasi</h3>
